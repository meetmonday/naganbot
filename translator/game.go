...
var GameTranslations = translations{
	"ru": {
		...
		"user game statistics games":             {message: PluralMessage{one: "Вы участвовали в %games игре", few: "Вы участвовали в %games играх", many: "Вы участвовали в %games играх"}},
"user game statistics shots":             {message: PluralMessage{one: " и проиграли %shots раз", few: " и проиграли %shots раза", many: " и проиграли %shots раз"}},
"user game statistics participation streak": {message: PluralMessage{one: "\nСтрик участия: %ps_games игра", few: "\nСтрик участия: %ps_games игры", many: "\nСтрик участия: %ps_games игр"}},
"user game statistics loss streak":       {message: PluralMessage{one: "\nСтрик проигрышей: %ls_games раз", few: "\nСтрик проигрышей: %ls_games раза", many: "\nСтрик проигрышей: %ls_games раз"}},
